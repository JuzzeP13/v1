...
def check_dependencies():
    ...
    required = [
        ...
        'requests', 'duckduckgo_search', 'dotenv', 'bcrypt', 'email_validator',
        'PIL'
    ]
...
def init_database():
    ...
    from models import init_extended_db
    init_extended_db()
...
def main():
    ...
    print("   3. Запустите сервер: python server.py")
